...
import logo from "/public/images/logo/re-logo.jpg";
...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
  // You can add your logic here for handling success response
      if (username === "adminchecklist" && password === "adminchecklist") {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              Creating Sustainable Value & Enriching Customers & Communities across the World. 
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
               ...
               {/* <!-- Login error massage Alerts --> */}
{error ? (
  <div className="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9 m-5">
      ...
      <ul>
        <li className="leading-relaxed text-[#CD5D5D]">
          {/* Lorem Ipsum is simply dummy text of the printing */}
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-success py-4 rounded-lg hover:bg-success-dark"
                >
                  Log In
                </button>
              </form>
