...
const deleteChecklistTable = async (tableName) => {
  ...
  const deleteTableNameQuery = `DELETE FROM Mst_ChecklistMaster WHERE TableName = '${tableName}';`;
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      const packNamesQuery = 'SELECT DISTINCT battery_pack_name FROM dbo.final_qrcode_details';
